...
# example.com/helm-proxy-demo-bundle:$VERSION and example.com/helm-proxy-demo-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/amacdona/helm-proxy-demo
...
ifeq (,$(shell which helm-operator 2>/dev/null))
	...
	curl -sSLo $(HELM_OPERATOR) https://github.com/operator-framework/operator-sdk/releases/download/v1.8.2/helm-operator_$(OS)_$(ARCH) ;\
